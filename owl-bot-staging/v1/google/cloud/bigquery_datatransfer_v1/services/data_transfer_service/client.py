    ...
    def delete_transfer_config(self,
        ...
        .. code-block::
            ...
            def sample_delete_transfer_config():
                ...
                # Make the request
                response = client.delete_transfer_config(request=request)
    ...
    def delete_transfer_run(self,
        ...
        .. code-block::
            ...
            def sample_delete_transfer_run():
                ...
                # Make the request
                response = client.delete_transfer_run(request=request)
    ...
    def enroll_data_sources(self,
        ...
        .. code-block::
            ...
            def sample_enroll_data_sources():
                ...
                # Make the request
                response = client.enroll_data_sources(request=request)
