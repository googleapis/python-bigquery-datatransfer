...
class DataSourceParameter(proto.Message):
    ...
    min_value = proto.Field(proto.MESSAGE, number=9,
        message=wrappers.DoubleValue,
    )

    max_value = proto.Field(proto.MESSAGE, number=10,
        message=wrappers.DoubleValue,
    )

    fields = proto.RepeatedField(proto.MESSAGE, number=11,
...
class DataSource(proto.Message):
    ...
    transfer_type = proto.Field(proto.ENUM, number=7,
    ...
    parameters = proto.RepeatedField(proto.MESSAGE, number=12,
        message='DataSourceParameter',
    )

    help_url = proto.Field(proto.STRING, number=13)

    authorization_type = proto.Field(proto.ENUM, number=14,
    ...
    minimum_schedule_interval = proto.Field(proto.MESSAGE, number=18,
...
class ListDataSourcesResponse(proto.Message):
    ...
    data_sources = proto.RepeatedField(proto.MESSAGE, number=1,
        message='DataSource',
    )
...
class CreateTransferConfigRequest(proto.Message):
    ...
    transfer_config = proto.Field(proto.MESSAGE, number=2,
...
class UpdateTransferConfigRequest(proto.Message):
    ...
    transfer_config = proto.Field(proto.MESSAGE, number=1,
        message=transfer.TransferConfig,
    )
...
class ListTransferConfigsResponse(proto.Message):
    ...
    transfer_configs = proto.RepeatedField(proto.MESSAGE, number=1,
        message=transfer.TransferConfig,
    )
...
class ListTransferRunsRequest(proto.Message):
    ...
    states = proto.RepeatedField(proto.ENUM, number=2,
    ...
    run_attempt = proto.Field(proto.ENUM, number=5,
        enum=RunAttempt,
    )
...
class ListTransferRunsResponse(proto.Message):
    ...
    transfer_runs = proto.RepeatedField(proto.MESSAGE, number=1,
...
class ListTransferLogsRequest(proto.Message):
    ...
    message_types = proto.RepeatedField(proto.ENUM, number=6,
...
class ListTransferLogsResponse(proto.Message):
    ...
    transfer_messages = proto.RepeatedField(proto.MESSAGE, number=1,
...
class ScheduleTransferRunsResponse(proto.Message):
    ...
    runs = proto.RepeatedField(proto.MESSAGE, number=1,
        message=transfer.TransferRun,
    )
...
class StartManualTransferRunsRequest(proto.Message):
    ...
    requested_time_range = proto.Field(proto.MESSAGE, number=3, oneof='time',
        message=TimeRange,
    )

    requested_run_time = proto.Field(proto.MESSAGE, number=4, oneof='time',
        message=timestamp.Timestamp,
    )
